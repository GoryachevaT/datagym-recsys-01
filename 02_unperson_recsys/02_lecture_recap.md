...
- возможность протестировать бизнес процессов
- отличная возможность поитерироваться с метриками с заказчиком (и вообще пониманием задачи) [история про детект брака в сталепрокате]
- эксперименты с бейслайном могут дать понимание информацию о пользователях: 
...
- апсейл аксесуаров и мелких товаров
    - аксесуары в м-видео будут преследовать до конца оформления заказа: https://www.mvideo.ru/products/noutbuk-apple-macbook-air-13-i5-1-8-8gb-128ssd-mqd32ru-a-30028577
...
- популярности (что такое популярность? клики? просмотры? покупки?) проблемы: кликбейт, статичный топ, невозможно найти что-то нужное
Пример с кворой как собирать клики: https://www.quora.com/topic/Recommender-Systems-1 
 - по рейтингу / оценке (проблема: если решать влоб, то в топе айтемы с 2 оценками, если сразу получить низкую оценку, то подняться не получится)
...
- контент
- one hot фичах, тегах, ключевых словах, описании
...
- **Ранжирование** 
    ...
    - читывают регион, но предлагают делают отдельный рейтинг без учета региона с авито-доставкой
...
Неперсонализированная подборка - хорошая заглушка для реко сервиса:
- если лежит рекомендатор, то показывается редакторская подборка
- если не работает ML поиск похожих, топодключается поиск похожих по жанрам и тегам
...
Топовая статья recsys 2019 разгром SOTA решений бейслайнами:
